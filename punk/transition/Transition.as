package punk.transition
{
	...
	public class Transition
	{
		...
		public static function toPixelate(inWorld:*):void
		{
			to(inWorld, new PixelateOut(), new PixelateIn());
		}
		
		public static function toAlpha(inWorld:*):void
		{
			to(inWorld, new FadeIn(), new FadeOut());
		}
